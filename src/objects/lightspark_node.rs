...
pub struct LightsparkNode {
    ...
    #[serde(with = "custom_date_format", rename = "lightspark_node_created_at")]
    pub created_at: DateTime<Utc>,

    /// The date and time when the entity was last updated.
    #[serde(with = "custom_date_format", rename = "lightspark_node_updated_at")]
    ...
    #[serde(rename = "lightspark_node_alias")]
    pub alias: Option<String>,

    /// The Bitcoin Network this node is deployed in.
    #[serde(rename = "lightspark_node_bitcoin_network")]
    ...
    #[serde(rename = "lightspark_node_color")]
    ...
    #[serde(rename = "lightspark_node_conductivity")]
    ...
    #[serde(rename = "lightspark_node_encrypted_signing_private_key")]
    ...
    #[serde(rename = "lightspark_node_local_balance")]
...
impl LightsparkNode {
    ...
    pub async fn get_channels(
        ...
        let query = "query FetchLightsparkNodeToChannelsConnection($entity_id: ID!, $first: Int, $statuses: [ChannelStatus!]) {
    entity(id: $entity_id) {
        ... on LightsparkNode {
