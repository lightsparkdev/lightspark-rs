...
impl Channel {
    ...
    pub async fn get_uptime_percentage(&self, requester:&impl GraphQLRequester, after_date: Option<DateTime<Utc>>, before_date: Option<DateTime<Utc>>) -> Result<Option<i64>, Error> {
    ...
    pub async fn get_transactions(&self, requester:&impl GraphQLRequester, types: Option<Vec<TransactionType>>, after_date: Option<DateTime<Utc>>, before_date: Option<DateTime<Utc>>) -> Result<ChannelToTransactionsConnection, Error> {
