...
pub enum ConnectionEnum {
    ...
    WithdrawalRequestToChannelClosingTransactionsConnection(WithdrawalRequestToChannelClosingTransactionsConnection),
    WithdrawalRequestToChannelOpeningTransactionsConnection(WithdrawalRequestToChannelOpeningTransactionsConnection),
        ...
        if let Some(typename) = value.get("__typename").and_then(Value::as_str) {
            match typename {
                "AccountToApiTokensConnection" => {
                    let obj = AccountToApiTokensConnection::deserialize(value)
                        .map_err(|err|
                ...
                "AccountToChannelsConnection" => {
                    let obj = AccountToChannelsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "AccountToNodesConnection" => {
                    let obj = AccountToNodesConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "AccountToPaymentRequestsConnection" => {
                    let obj = AccountToPaymentRequestsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "AccountToTransactionsConnection" => {
                    let obj = AccountToTransactionsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "AccountToWalletsConnection" => {
                    let obj = AccountToWalletsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "AccountToWithdrawalRequestsConnection" => {
                    let obj = AccountToWithdrawalRequestsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "IncomingPaymentToAttemptsConnection" => {
                    let obj = IncomingPaymentToAttemptsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "LightsparkNodeToChannelsConnection" => {
                    let obj = LightsparkNodeToChannelsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "OutgoingPaymentAttemptToHopsConnection" => {
                    let obj = OutgoingPaymentAttemptToHopsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "OutgoingPaymentToAttemptsConnection" => {
                    let obj = OutgoingPaymentToAttemptsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "WalletToPaymentRequestsConnection" => {
                    let obj = WalletToPaymentRequestsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "WalletToTransactionsConnection" => {
                    let obj = WalletToTransactionsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "WalletToWithdrawalRequestsConnection" => {
                    let obj = WalletToWithdrawalRequestsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "WithdrawalRequestToChannelClosingTransactionsConnection" => {
                    let obj = WithdrawalRequestToChannelClosingTransactionsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                    Ok(ConnectionEnum::WithdrawalRequestToChannelClosingTransactionsConnection(obj))
                },
                "WithdrawalRequestToChannelOpeningTransactionsConnection" => {
                    let obj = WithdrawalRequestToChannelOpeningTransactionsConnection::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                    Ok(ConnectionEnum::WithdrawalRequestToChannelOpeningTransactionsConnection(obj))
                },

                _ => Err(serde::de::Error::custom("unknown typename")),
            }
        } else {
            Err(serde::de::Error::custom("missing __typename field on Connection"))
        }
    }
}
