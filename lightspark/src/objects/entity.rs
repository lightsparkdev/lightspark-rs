        ...
        D: Deserializer<'de>,
    {
        ...
        if let Some(typename) = value.get("__typename").and_then(Value::as_str) {
            match typename {
                ...
                "Channel" => {
                    let obj = Channel::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "ChannelSnapshot" => {
                    let obj = ChannelSnapshot::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "IncomingPaymentAttempt" => {
                    let obj = IncomingPaymentAttempt::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "Invoice" => {
                    let obj = Invoice::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "OutgoingPaymentAttempt" => {
                    let obj = OutgoingPaymentAttempt::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "Signable" => {
                    let obj = Signable::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "SignablePayload" => {
                    let obj = SignablePayload::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "UmaInvitation" => {
                    let obj = UmaInvitation::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
                ...
                "WithdrawalRequest" => {
                    let obj = WithdrawalRequest::deserialize(value)
                        .map_err(|err|
                            serde::de::Error::custom(format!("Serde JSON Error {}", err))
                        )?;
            ...
            Err(serde::de::Error::custom("missing __typename field on Entity"))
        }
    }
}
