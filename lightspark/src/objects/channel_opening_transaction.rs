...
pub struct ChannelOpeningTransaction {
    ...
    #[serde(with = "custom_date_format", rename = "channel_opening_transaction_created_at")]
    pub created_at: DateTime<Utc>,

    /// The date and time when the entity was last updated.
    #[serde(with = "custom_date_format", rename = "channel_opening_transaction_updated_at")]
    ...
    #[serde(with = "custom_date_format_option", rename = "channel_opening_transaction_resolved_at")]
