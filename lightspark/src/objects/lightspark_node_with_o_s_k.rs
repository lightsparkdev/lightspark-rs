...
pub struct LightsparkNodeWithOSK {
    ...
    #[serde(with = "custom_date_format", rename = "lightspark_node_with_o_s_k_created_at")]
...
impl LightsparkNodeWithOSK {
    ...
    pub async fn get_channels(&self, requester:&impl GraphQLRequester, first: Option<i64>, after: Option<String>, before_date: Option<DateTime<Utc>>, after_date: Option<DateTime<Utc>>, statuses: Option<Vec<ChannelStatus>>) -> Result<LightsparkNodeToChannelsConnection, Error> {
