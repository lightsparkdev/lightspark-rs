...
impl IncomingPayment {
    ...
    pub async fn get_attempts(&self, requester:&impl GraphQLRequester, first: Option<i64>, statuses: Option<Vec<IncomingPaymentAttemptStatus>>, after: Option<String>) -> Result<IncomingPaymentToAttemptsConnection, Error> {
